...
{
    internal class DeepDigerHead : ZenWorm
    {
		...
		public override void CustomBehavior()
		{
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				if (attackCounter <= 0 && Vector2.Distance(npc.Center, target.Center) < 200 && Collision.CanHit(npc.Center, 1, 1, target.Center, 1, 1))
				{
					...
					int projectile = Projectile.NewProjectile(npc.Center, direction * 1, ModContent.ProjectileType<ZenBeamLazerWormHostile>(), 25, 0, Main.myPlayer);
        ...
        {
			spriteBatch.Draw(mod.GetTexture("Items/NewZenStuff/Biome/WormAttempt/HeadGlow"), npc.Center - Main.screenPosition, null, Color.White, npc.rotation, new Vector2(11, 14), 1f, SpriteEffects.None, 1f);
		}
	...
	public class ZenBeamLazerWormHostile : ModProjectile
    {
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, ModContent.DustType<ZenBeamDustWorm>(), projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
			}
			Vector2 velocity = projectile.velocity;
			if (projectile.velocity.X != velocity.X)
			{
				projectile.position.X += projectile.velocity.X;
				projectile.velocity.X = 0f - velocity.X;
			}
			if (projectile.velocity.Y != velocity.Y)
			{
				projectile.position.Y += projectile.velocity.Y;
				projectile.velocity.Y = 0f - velocity.Y;
			}
		}
    }
	public class ZenBeamDustWorm : ModDust
    {
	...
	internal class DeepDigerBody : ZenWorm
    {
		public override void SetDefaults()
		{
	...
	internal class DeepDigerEnd : ZenWorm
    {
		public override void SetDefaults()
		{
	...
	public abstract class ZenWorm : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Deep Digger");
		}
		...
		public override void Init()
		{
			minLength = 13;
			maxLength = 17;
			tailType = ModContent.NPCType<DeepDigerEnd>();
			bodyType = ModContent.NPCType<DeepDigerBody>();
			headType = ModContent.NPCType<DeepDigerHead>();
			speed = 5.7f;
			turnSpeed = 0.047f;
		}
	}
