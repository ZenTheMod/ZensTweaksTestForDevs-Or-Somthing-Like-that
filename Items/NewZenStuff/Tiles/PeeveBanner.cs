...
{
    public class PeeveBanner : ModTile
    {
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			...
			player.NPCBannerBuff[mod.NPCType("ZenStonePeeve")] = true;
			player.hasBanner = true;
		}

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<Items.PeeveBanner_I>());
		}
	}
}
