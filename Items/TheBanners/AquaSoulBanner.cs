...
{
    public class AquaSoulBanner : ModItem
    {
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Nearby players get a bonus against: Aqua Soul");
		}
		...
		public override void SetDefaults()
		{
			...
			item.createTile = ModContent.TileType<AquaSoulBannerPlaced>();
		}
	}
	public class AquaSoulBannerPlaced : ModTile
    {
		public override void SetDefaults()
		{
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			...
			player.NPCBannerBuff[ModContent.NPCType<AquaSoul>()] = true;
			player.hasBanner = true;
		}

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<AquaSoulBanner>());
		}
	}
}
